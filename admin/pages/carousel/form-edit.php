        ...
        <form role="form" action="update.php" method="post" enctype="multipart/form-data">
          <div class="card-body">
            <div class="form-group">
              ...
              <input type="text" class="form-control" id="topic" name="topic" value="<?php echo htmlspecialchars($row['topic']); ?>" placeholder="เพิ่มหัวข้อกิจกรรม" required>
            </div>
            ...
            <div class="form-group">
              ...
              <figure class="figure text-center d-block mt-2">
                ...
                <img id="imgUpload" src="../../../asset/images/carousel/<?php echo $row['image']; ?>" class="figure-img img-fluid rounded" alt="">
              </figure>
            </div>
          </div>
