  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>จัดการข้อมูลประชาสัมพันธ์</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="../dashboard">Dashboard</a></li>
              <li class="breadcrumb-item active">จัดการข้อมูลประชาสัมพันธ์</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
    ...
    <section class="content">
      ...
      <div class="card">
        <div class="card-header">
          ...
          <a href="form-create.php" class="btn btn-primary float-right "> เพิ่มหัวข้อ + </a>
        </div>
        <!-- /.card-header -->
        <div class="card-body">
          <table id="dataTable" class="table table-bordered table-striped">
            ...
            ?>
              <tr>
                <td><?php echo $num;  ?></td>
                <td><img class="img-fluid d-block mx-auto" src="../../../asset/images/carousel/<?php echo $row['image']; ?>" width="150px" alt=""></td>
